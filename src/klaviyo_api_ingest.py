...
def fetch_campaigns(page_token=None, dry_run=False):
    ...
    if dry_run:
        ...
        # Return different mock data based on page token
        if not page_token:
            return [
                {
                    "id": "campaign_123",
            ...
            return [
                {
                    ...
                    "send_time": "2025-05-15T10:00:00Z",
...
def main():
    ...
    if not output_file:
        output_file = "campaigns.csv" if args.format == "csv" else "campaigns.json"
    ...
    # Write data to file
    if args.format == "csv":
        write_to_csv(campaigns, output_file)
    else:
        write_to_json(campaigns, output_file)
